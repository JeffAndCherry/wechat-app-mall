...
var INDEXNAVIGATION = [ //首页图标导航，'id' 为导航的Id，可以自定义，'name'为名称，'image'为图标路径，'url' 为跳转页面
  { id: '1', name: '景点展示', image: '../../images/Attractions.png', url: '../list-post/list?id=5392'},
  { id: '2', name: '景区活动', image: '../../images/Strategy.png', url: '../list-post/list?id=5393'},
  { id: '3', name: '景区政务', image: '../../images/Travels.png', url: '../list-post/list?id=5394'},
  { id: '4', name: '景区招聘', image: '../../images/wxParse.png', url: '../list-post/list?id=5395'}
]
