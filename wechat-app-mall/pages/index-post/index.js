...
Page({
  data: {
    postsList: [],
    swiperList: [{ id: 1, thumbnail: '/images/cover.png' }, { id: 2, thumbnail: '/images/random.png' }, { id: 3, thumbnail: '/images/SearchImage.png' }],
    Swiper: true,
    isLastPage: false,
    page: 1,
    search: '',
